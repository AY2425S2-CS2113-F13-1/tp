...
## Design
### Architecture
### UI Component (Printer / Animation)
### Logic Component (Parser / Commands)
### Model Component (UserData / Achievements)
### Storage Component
### Common classes (Exceptions / Logger)
...
The proposed view achievements feature will allow users to see all achievements they've unlocked and those still locked.
